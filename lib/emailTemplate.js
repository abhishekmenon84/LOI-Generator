...
// this? ..."); optional.
export function renderEmail({ title, body, ctaLabel, ctaUrl, footerNote }) {
  return `
<div style="background:#f7f7f5; padding: 40px 16px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif;">
  <div style="max-width: 560px; margin: 0 auto; background: #ffffff; border-radius: 16px; padding: 40px; border: 1px solid #ececec;">
    <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 28px;">
      <div style="width: 36px; height: 36px; background: #16161a; border-radius: 9px; display: inline-flex; align-items: center; justify-content: center;">
        ${LOGO_SVG}
      </div>
      <span style="font-size: 18px; font-weight: 800; color: #16161a;">Ledgerlot</span>
    </div>
