...
// Returns null for a seat count below 2 (single-seat orgs don't fit any
// bracket -- the smallest business tier starts at 2 seats) or above 100
// only if BUSINESS_SEAT_TIERS' top bracket didn't already cover it (it
// does, via Infinity, so this is effectively just the <2 guard).
