    ...
    sections: [
      {
        ...
        children: [
          new Paragraph({
            ...
            spacing: { after: 300 },
            children: [
              new TextRun({ text: "LETTER OF INTENT TO LEASE", bold: true, size: 28 }),
            ],
          }),
          new Paragraph({
            spacing: { after: 100 },
          ...
          new Paragraph({
            spacing: { after: 100 },
            children: [new TextRun({ text: "1. PARTIES & PREMISES", bold: true })],
          }),
          new Paragraph({
            spacing: { after: 200 },
            children: [
          ...
          new Paragraph({
            spacing: { after: 100 },
            children: [new TextRun({ text: "2. LEASE TERM & COMMENCEMENT", bold: true })],
          }),
          new Paragraph({
            spacing: { after: 200 },
            children: [
          ...
          new Paragraph({
            spacing: { after: 100 },
            children: [new TextRun({ text: "3. BASE RENT & ESCALATIONS", bold: true })],
          }),
          new Paragraph({
            spacing: { after: 100 },
            children: [
          ...
          new Paragraph({
            spacing: { after: 100 },
            children: [new TextRun({ text: "4. SECURITY DEPOSIT", bold: true })],
          }),
          new Paragraph({
            spacing: { after: 200 },
            children: [
          ...
          new Paragraph({
            spacing: { after: 100 },
            children: [new TextRun({ text: "5. PERMITTED USE", bold: true })],
          }),
          new Paragraph({
            spacing: { after: 200 },
          ...
          new Paragraph({
            spacing: { after: 100 },
            children: [new TextRun({ text: "6. TENANT IMPROVEMENTS / BUILD-OUT ALLOWANCE", bold: true })],
          }),
          new Paragraph({
            spacing: { after: 100 },
            children: [
          ...
          new Paragraph({
            spacing: { after: 100 },
            children: [new TextRun({ text: "7. RENEWAL OPTION(S)", bold: true })],
          }),
          new Paragraph({
            spacing: { after: 200 },
          ...
          new Paragraph({
            spacing: { after: 100 },
            children: [new TextRun({ text: "8. BROKERAGE COMMISSION", bold: true })],
          }),
          new Paragraph({
            spacing: { after: 200 },
            children: [
          ...
          new Paragraph({
            spacing: { after: 100 },
            children: [new TextRun({ text: "9. CONDITIONS PRECEDENT", bold: true })],
          }),
          ...model.conditions.map((c) => bulletParagraph(c)),

          new Paragraph({
            spacing: { before: 200, after: 300 },
            children: [new TextRun({ text: "10. NON-BINDING NATURE", bold: true })],
          }),
          new Paragraph({
            spacing: { after: 400 },
            children: [
          ...
          ...(model.agencyDisclosures.length > 0
            ? [
                new Paragraph({
                  spacing: { before: 200, after: 300 },
                  children: [new TextRun({ text: "11. AGENCY DISCLOSURE", bold: true })],
                }),
                ...model.agencyDisclosures.map(
                  (d) =>
                    new Paragraph({
    ...
    sections: [
      {
        ...
        children: [
          new Paragraph({
            alignment: AlignmentType.CENTER,
            spacing: { after: 100 },
            children: [new TextRun({ text: "RESIDENTIAL LEASE", bold: true, size: 28 })],
          }),
          new Paragraph({
            alignment: AlignmentType.CENTER,
            spacing: { after: 300 },
          ...
          new Paragraph({ spacing: { after: 100 }, children: [new TextRun({ text: "SECTION 1 — PARTIES", bold: true })] }),
          new Paragraph({
            spacing: { after: 100 },
            children: [
          ...
          new Paragraph({ spacing: { before: 200, after: 100 }, children: [new TextRun({ text: "SECTION 2 — PREMISES", bold: true })] }),
          new Paragraph({
            spacing: { after: 100 },
            children: [new TextRun(`Address: ${model.premisesAddressText}. Type of premises: ${model.premisesTypeText}.`)],
          }),

          new Paragraph({ spacing: { before: 200, after: 100 }, children: [new TextRun({ text: "SECTION 3 — LENGTH OF TENANCY", bold: true })] }),
          new Paragraph({ spacing: { after: 100 }, children: [new TextRun(model.tenancyText)] }),

          new Paragraph({ spacing: { before: 200, after: 100 }, children: [new TextRun({ text: "SECTION 4 — RENT", bold: true })] }),
          ...
          new Paragraph({ spacing: { before: 200, after: 100 }, children: [new TextRun({ text: "SECTION 5 — SECURITY DEPOSIT", bold: true })] }),
          new Paragraph({ spacing: { after: 100 }, children: [new TextRun(model.securityDepositText)] }),

          new Paragraph({ spacing: { before: 200, after: 100 }, children: [new TextRun({ text: "SECTION 6 — ASSIGNMENT", bold: true })] }),
          ...
          new Paragraph({ spacing: { before: 200, after: 100 }, children: [new TextRun({ text: "SECTION 7 — SIGNATURES", bold: true })] }),
